...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "asset, READ-ONLY, no RT cyclic; raw-socket extra), and the ENERGY edition "
        "(READ-ONLY): IEC 60870-5-104 (c104 — link/interrogation/point), DNP3 "
        "(pydnp3 — link/integrity-poll), IEC 61850 MMS (libiec61850 — model "
        "browse/read); plus the BUILDING edition (READ-ONLY): BACnet/IP (BAC0 — "
        "Who-Is discovery, object-list, present-value reads for facility/HVAC). "
        "Energy + building connectors are preview/待核实, optional extras. Call "
